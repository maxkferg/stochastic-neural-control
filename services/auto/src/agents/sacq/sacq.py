...
from agents.sacq.sacq_policy import SACQTFPolicy
...
SACQTrainer = GenericOffPolicyTrainer.with_updates(
    name="SACQ", default_config=DEFAULT_CONFIG, default_policy=SACQTFPolicy)