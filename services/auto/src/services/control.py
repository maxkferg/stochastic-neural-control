...
class ControlGenerator():
    ...
    def __init__(self, api_config, verbosity=0):
        """
        ...
        self.checkpoint_path = api_config["checkpoint"]
    ...
    def _publish_robot_action(self, robot_id, action):
        ...
        scale_throttle = self.api_config["scale_throttle"]
        scale_steering = self.api_config["scale_steering"]
        message = {
          "robot": {
            "id": robot_id,
          },
        ...
        for partition, messages in result.items():
            for msg in messages:
                ...
                a_action = agent.compute_action(
                    ...
                    prev_reward=None,
                    policy_id=policy_id)
                print("Action for %s:"%robot_id, a_action)
