...
class ObservationGenerator():
    ...
    def __init__(self, api_config, min_timestep=0.1, headless=True, verbosity=0):
        """
        ...
        self.building_id = api_config["building_id"]
        self.min_timestep = min_timestep
        self.kafka_producer = self._setup_kafka_producer(kafka_host)
        self.env = self._setup_simulator(self.building_id)
